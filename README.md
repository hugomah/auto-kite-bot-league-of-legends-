...
it's made using basic C sharp implementation, i must admit that i don't really know if it's really bannable (i personnaly thik it anticheat proof) but the best way
to avoid that is too customize it by yoursef! The code is open source (it is normally linked to the project by now, i'll show you part of it right under). I've been strongly inspired by a user called -approved-
